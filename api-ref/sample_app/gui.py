...
def register_user():
    ...
    # data above needs to be hashed before sending
    username_info = username.get()
    password_info = password.get()  # similar to email
    ...
    print(payload)
    response = requests.post(url, data=payload)  # send a POST request

    res = json.loads(response.text) # get the text of the response and converts it into dict
    print('txid: ', res)
